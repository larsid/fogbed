...
from mininet.node import Controller, Docker, UserSwitch


class FogbedExperiment:
    def __init__(self, topology: FogTopo) -> None:
        self.topology = topology
        self.topology.create()
        self.net = Fogbed(topo=topology, controller=Controller, switch=UserSwitch)
